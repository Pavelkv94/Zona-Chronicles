 ...
 */
// 0.4.0 — I06: у мест и дорог появилась опасность; добавлен овраг — вторая дорога из двора.
//          Станция связи НЕ соединена и соединена не будет, пока на её недостижимости держится
//          D12 «путь к недостижимой локации отвергается названной причиной» (PLAN I06 §12.2).
...
export const PROTOTYPE_RULESET_VERSIONS = {
  ...
  // 0.6.0 — ревью I04-I06 (M1): диапазон осторожности переехал в правила из литералов генератора
  //         мира. Он влияет на то, каким получится мир при данном seed, а значит обязан входить
  //         в rules bundle — иначе его правка меняла бы мир, не двигая ни одной версии.
