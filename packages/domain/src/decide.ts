 ...
 * потому что идущий НАХОДИТСЯ на дороге: прерванный путь оставил бы его между местами, а такого
 * положения мир выразить не умеет. (Прежнее обоснование — «маршрут выбирает оператор, а не
 * агент» — умерло в I06-C, когда дорога стала шагом цели «уйти»; найдено ревью I04-I06, m2.)
 *
